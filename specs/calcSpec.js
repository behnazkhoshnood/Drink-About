describe("MY whatCanIDrink function", function () {
    ...
    describe("check age", function () {
        ...
        it("should unable to return a drink when called as WhatCAnIDrink(-1)", function () {
            var result = whatCanIDrink(-1)
            expect(result).toBe("Sorry. I can’t tell what drink because that age is incorrect!");
        });
        it("should unable to return a drink when called as WhatCAnIDrink(150)", function () {
            var result = whatCanIDrink(150)
            expect(result).toBe("Sorry. I can’t tell what drink because that age is incorrect!");
        });

        it("should contain Drink when called as whatCanIDrink(18)", function () {
